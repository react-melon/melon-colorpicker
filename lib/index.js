(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-core/InputComponent', 'melon-core/classname/cxBuilder', 'react-motion', 'melon-layer', 'melon/Icon', 'melon/Button', 'dom-align', 'kolor'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-core/InputComponent'), require('melon-core/classname/cxBuilder'), require('react-motion'), require('melon-layer'), require('melon/Icon'), require('melon/Button'), require('dom-align'), require('kolor'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.InputComponent, global.cxBuilder, global.reactMotion, global.melonLayer, global.Icon, global.Button, global.domAlign, global.kolor);
        global.index = mod.exports;
    }
})(this, function (exports, _react, _InputComponent2, _cxBuilder, _reactMotion, _melonLayer, _Icon, _Button, _domAlign, _kolor) {
    'use strict';
    ...
    var ColorPicker = function (_InputComponent) {
        ...
        ColorPicker.prototype.onSaturationChange = function onSaturationChange(e) {
            ...
            // 获取用户点击位置 left -> hsv.s
            var s = (pageX - left) / SV_SIZE;

            // 获取用户点击位置 top -> hsv.v
            var v = 1 - (pageY - top) / SV_SIZE;

            this.setState({ s: s, v: v });
        };

        ColorPicker.prototype.onAlphaChange = function onAlphaChange(e) {
            var currentTarget = e.currentTarget,
                pageY = e.pageY;
                ...
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        'div',
                        {
                            ...
                            style: {
                                backgroundColor: _kolor2['default'].hsv(h, 1, 1).rgb().css()
                            },
